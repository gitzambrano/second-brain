...
wiki/
  ...
  book-chapters/         reservado para um projeto de livro futuro — ver AGENTS.md
...
| Plan       | `/plan`            | Orquestra`plan/plano.md` (5 seções) e chama a skill certa ao retomar um item                             |
| Study      | `/study`           | Sessão de estudo de verdade: busca fontes, faz perguntas socráticas, gera conexões                       |
