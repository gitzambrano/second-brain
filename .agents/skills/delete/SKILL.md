...
description: >
  ...
  índice, manifesto). Use quando o Usuário disser "apaga esse
...
7. **Rode `/organize`** — é ele quem repara os wikilinks órfãos deixados pela remoção (relata cada um, pergunta se remove o link, aponta pra outra página, ou vira um essay novo).
